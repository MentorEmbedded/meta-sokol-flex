...
FILESEXTRAPATHS:prepend:feature-flex-staging := "${THISDIR}/lttng-tools:"
...
STAGING_ENABLED = ""
STAGING_ENABLED:feature-flex-staging = "1"
...
PACKAGE_BEFORE_PN:prepend:feature-flex-staging = "${PN}-consumerd liblttng-ctl "

RDEPENDS:${PN}:append:feature-flex-staging = " ${PN}-consumerd ${MLPREFIX}liblttng-ctl"
