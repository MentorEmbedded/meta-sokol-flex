...
SRC_URI += "\
    ...
    file://unstable.patch \
"
SRCREV = "204d0d2a2be389188577dbb22da63a3ebc267df9"
...
# Note:
# 1. rutabaga 0.1.75 crate need to be patched to sync with upstream using Cargo.toml [patch.crates-io]
...
do_install() {
    ...
    sed -e 's:@libdir@:${libdir}:' \
      ...
      ${WORKDIR}/rutabaga_gfx_ffi.pc.in > ${D}${libdir}/pkgconfig/rutabaga_gfx_ffi.pc
